...
tracex(id2Constrained, legis =  "800", d = 1)
tracex(id2Constrained, legis =  "800", d = 2)
tracex(id2Constrained, legis =  "800", d = 3)

tracex(id2Constrained, legis =  "361", d = 1)
tracex(id2Constrained, legis =  "361", d = 2)
tracex(id2Constrained, legis =  "361", d = 3)

tracex(id2Constrained, legis =  "110", d = 1)
tracex(id2Constrained, legis =  "110", d = 2)
tracex(id2Constrained, legis =  "110", d = 3)
...
diagnostic_theta <- function(num, N, K){
  mcmc_obj <- mcmc(as.data.frame(t(THETA[num, , ])))
  print(summary(mcmc_obj))
  print("Effective Sample Size:")
  print(effectiveSize(mcmc_obj))
  #png(paste0("Nigeria/results/R2_THETA", num, "_N", N, "_K", K, ".png"))
  plot(mcmc_obj)
  #dev.off()
}

diagnostic_theta (800, N, K)
diagnostic_theta (361, N, K)
diagnostic_theta (110, N, K)


##### ---------------------- Malawi ------------------------ #####
load("~/Desktop/Interventions/Theory-IRT/Results/Malawi/Malawi_R5_THETA.RData")
THETA_Malawi_R5 <- THETA
load("~/Desktop/Interventions/Theory-IRT/Results/Malawi/Malawi_R6_THETA.RData")
THETA_Malawi_R6 <- THETA
load("~/Desktop/Interventions/Theory-IRT/Results/Malawi/Malawi_R2_THETA.RData")
THETA_Malawi_R2 <- THETA
load("~/Desktop/Interventions/Theory-IRT/Results/Liberia/Liberia_R4_THETA.RData")
THETA_Liberia_R4 <- THETA
load("~/Desktop/Interventions/Theory-IRT/Results/Liberia/Liberia_R5_THETA.RData")
THETA_Liberia_R5 <- THETA
...
Geweke_convergence(THETA_Malawi_R5)
Geweke_convergence(THETA_Malawi_R6)
Geweke_convergence(THETA_Malawi_R2)
Geweke_convergence(THETA_Liberia_R4)
Geweke_convergence(THETA_Liberia_R5)
